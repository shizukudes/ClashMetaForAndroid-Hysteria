            ...
            select<Unit> {
                ...
                design.requests.onReceive { request ->
                    when (request) {
                        ...
                        HysteriaSettingsDesign.Request.OpenDonate -> {
                            startActivity(Intent(Intent.ACTION_VIEW).setData(Uri.parse(getString(com.github.kr328.clash.design.R.string.donate_saweria_url))))
                        }
